...
<body>
    <div style="display: flex; justify-content: space-between; align-items: center; padding: 10px 0; border-bottom: 2px solid #ddd; margin-bottom: 20px;">
    <div style="text-align: left; line-height: 1.2;">
      <p style="margin: 0; font-size: 1.1em; font-weight: bold;">CENTRO EDUCATIVO PEQUEÑOS GENIOS</p>
      <p style="margin: 0; font-size: 0.8em;">Resolución No. 351 agosto 19 de 2010</p>
      <p style="margin: 0; font-size: 0.8em;">Secretaría de Educación Municipal</p>
      <p style="margin: 0; font-size: 0.8em;">DANE 344001001311 NIT 900381245 - 6</p>
      <p style="margin: 0; font-size: 0.8em;">Cl 15 No. 12 C 03</p>
...
        {/* INICIO: Encabezado para la vista previa en el navegador */}
        <div style={{
          display: 'flex',
...
            <p style={{ margin: '0', fontSize: '1.1em', fontWeight: 'bold' }}>CENTRO EDUCATIVO PEQUEÑOS GENIOS</p>
            <p style={{ margin: '0', fontSize: '0.8em' }}>Resolución No. 351 agosto 19 de 2010</p>
            <p style={{ margin: '0', fontSize: '0.8em' }}>Secretaría de Educación Municipal</p>
            <p style={{ margin: '0', fontSize: '0.8em' }}>DANE 344001001311 NIT 900381245 - 6</p>
            <p style={{ margin: '0', fontSize: '0.8em' }}>Cl 15 No. 12 C 03</p>
            <p style={{ margin: '0', fontSize: '0.8em' }}>Riohacha - La Guajira</p>
          </div>
          <div style={{ width: '100px' }}>
            <img
...
          </div>
        </div>
        {/* FIN: Encabezado para la vista previa */}
